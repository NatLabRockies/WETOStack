...
In an interactive Python interpreter (REPL, or run-execute-print-loop), typing \mint{python}|import this| prints the Zen of Python:
...
\begin{appendices} %<--------- All chapters after this will be labeled as appendices
    ...
    \appchapter{RSEs: The Engineers Behind Research Software}
    \label{app:A}
